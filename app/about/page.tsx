    ...
    <>
      <div className="page-hero">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-white mb-4">About Shritik Enterprises LLP</h1>
          <p className="text-green-100 text-lg max-w-2xl">An India-based manufacturer and exporter committed to delivering premium food ingredients to global buyers with consistency and care.</p>
        </div>
      </div>
              ...
              {milestones.map((m, i) => (
                <div key={m.year} className="flex gap-5">
                  <div className="flex flex-col items-center">
                    <div className="w-10 h-10 rounded-full bg-[#1a472a] flex items-center justify-center text-white text-xs font-bold flex-shrink-0">{m.year.slice(2)}</div>
                    {i < milestones.length - 1 && <div className="w-0.5 flex-1 bg-green-100 my-1" />}
                  </div>
                  <div className="pb-4">
      ...
      <section className="py-20 bg-[#f8fdf9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-gradient-to-br from-[#1a472a] to-[#2d6a4f] rounded-2xl p-8 text-white">
            ...
            <div className="bg-gradient-to-br from-[#b8860b] to-[#d4a017] rounded-2xl p-8 text-white">
              <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center mb-5">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v) => (
              <div key={v.title} className="p-6 border border-gray-100 rounded-2xl bg-white shadow-card hover:shadow-card-hover transition-all hover:-translate-y-1">
