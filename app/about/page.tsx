    ...
    <>
      <div className="page-hero">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="font-serif text-4xl sm:text-5xl font-bold text-white mb-4 ph-title">About Shritik Enterprises LLP</h1>
          <p className="text-green-100 text-lg max-w-2xl ph-subtitle">An India-based manufacturer and exporter committed to delivering premium food ingredients to global buyers with consistency and care.</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <ScrollReveal animation="left">
              <div>
                <ScrollReveal animation="down" delay={100}>
                ...
                <div className="grid grid-cols-2 gap-6">
                  <ScrollReveal animation="pop" delay={200}>
                    <div className="bg-[#f0fdf4] rounded-xl p-5 text-center border border-green-100">
                      <div className="font-serif text-4xl font-bold text-[#1a472a] mb-1">10+</div>
                  ...
                  <ScrollReveal animation="pop" delay={350}>
                    <div className="bg-amber-50 rounded-xl p-5 text-center border border-amber-100">
                      <div className="font-serif text-4xl font-bold text-amber-800 mb-1">30+</div>
            ...
            <ScrollReveal animation="right">
              <div className="space-y-4">
                {milestones.map((m, i) => (
                  <ScrollReveal key={m.year} animation="up" delay={delays[i]}>
                    <div className="flex gap-5">
                      <div className="flex flex-col items-center">
                        <div className="w-10 h-10 rounded-full bg-[#1a472a] flex items-center justify-center text-white text-xs font-bold flex-shrink-0 step-num-pulse">
                          {m.year.slice(2)}
                        </div>
                        {i < milestones.length - 1 && (
                          <div
                            className="w-0.5 flex-1 bg-green-100 my-1 timeline-line-anim"
                            style={{ '--line-delay': `${0.15 + i * 0.12}s` } as React.CSSProperties}
                          />
                        )}
                      </div>
                      <div className="pb-4">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-8">
            <ScrollReveal animation="left" delay={100}>
              <div className="bg-gradient-to-br from-[#1a472a] to-[#2d6a4f] rounded-2xl p-8 text-white h-full">
            ...
            <ScrollReveal animation="right" delay={200}>
              <div className="bg-gradient-to-br from-[#b8860b] to-[#d4a017] rounded-2xl p-8 text-white h-full">
                <div className="w-12 h-12 rounded-xl bg-white/10 flex items-center justify-center mb-5">
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {values.map((v, i) => (
              <ScrollReveal key={v.title} animation="bubble" delay={i * 100}>
                <div className="p-6 border border-gray-100 rounded-2xl bg-white shadow-card value-card h-full">
                  <div className="w-11 h-11 rounded-xl bg-[#f0fdf4] flex items-center justify-center mb-4 value-icon">
      ...
      <section className="py-16 bg-[#f0fdf4]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <ScrollReveal animation="blur-up">
            ...
            <p className="section-subheading mx-auto text-center mb-8">Whether you&apos;re sourcing for the first time or looking to switch suppliers, we&apos;re here to help you find the right product and terms.</p>
