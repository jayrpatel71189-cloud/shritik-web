    ...
    <>
      <div className="page-hero" style={{ background: 'linear-gradient(135deg, #581c87 0%, #7c3aed 60%, #a855f7 100%)' }}>
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-purple-100 text-lg max-w-2xl ph-subtitle">White and red onion — flakes, minced, granules, and powder. Consistent pungency, colour, and rehydration ratio for food manufacturers worldwide.</p>
        </div>
      </div>
                  ...
                  {[
                    ...
                    <ScrollReveal key={stat.label} animation="pop" delay={i * 80 + 200}>
                      <div className="bg-white rounded-xl p-4 shadow-sm">
                        ...
                        <div className="font-bold text-purple-800">{stat.value}</div>
                      </div>
                    </ScrollReveal>
                  ))}
                </div>
